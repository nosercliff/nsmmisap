...
class BillingRateTwoCreate extends Component {
    constructor(props) {
        super(props)
        this.state ={
            userinfo        :   [],
    ...
    componentDidMount(){
        ...
        this.props.onBillingRateTwoCreateRef(this)

    }

    componentWillUnmount() {
        this.props.onBillingRateTwoCreateRef()
    }
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title id="contained-modal-title-vcenter">
                        Billing Configuration >> Billing Rate 2 - Create
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Container>
                ...
                <Modal.Footer>
                    <ButtonToolbar >
                        <Button variant="success" className="ml-auto" onClick = { this.handleSubmitRateTwo }>
                            Save
                        </Button>&nbsp;&nbsp;
...
export  default BillingRateTwoCreate