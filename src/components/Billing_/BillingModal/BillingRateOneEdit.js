...
class BillingRateOneEdit extends Component {
    constructor(props) {
        super(props)
        this.state ={
            isLoading:false,
    ...
    componentDidMount(){
        ...
        this.props.onBillingRateOneEditRef(this)
    }

    componentWillUnmount() {
        this.props.onBillingRateOneEditRef()
    }
...
export  default BillingRateOneEdit