...
class AdministrationCoordinatorCreate extends Component {
    state = {
            ...
            <div>
                <Banner />
                    <Container className="mt-5">
                        <Card>
                            <Card.Header>Create Administration Coordinator</Card.Header>
                            <Card.Body>
                                <Form>
                                <Form.Row>
...
export default AdministrationCoordinatorCreate;