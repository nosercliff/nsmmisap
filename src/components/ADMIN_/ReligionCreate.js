...
class ReligionCreate extends Component {
    ...
    handleSaveClick = event => {
        ...
        axios
            .post(
                AppConfiguration.Setting().noserapiendpoint + "Maintenance/AddReligion",  religionParams
            )
            .then(res => {
                const data = res.data;
            ...
            <div>
                <Banner />
                    <Container className="mt-5">
                        <Card>
                            <Card.Header>Create Relegion</Card.Header>
                            <Card.Body>
                                <Form>
                                <Alert color="success" isOpen={this.state.show} color={this.state.Color} fade={this.state.Fade}>
                                    ...
                                    <ButtonToolbar sm={12} className="mt-3">
                                        ...
                                        <Button variant="danger" href="/Religions">
                                            Back
                                        </Button>
                                    </ButtonToolbar>
                                </Form>
