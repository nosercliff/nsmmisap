...
class NationalityCreate extends Component {
    constructor(props) {
        super(props)
        this.state = {
            userinfo  :   [],
    ...
    handleSaveClick = event => {
        ...
        axios
            .post(
                AppConfiguration.Setting().noserapiendpoint + "Maintenance/AddNationality",  addParams
            )
            .then(res => {
                const data = res.data;
            ...
            <div>
                <Banner />
                    <Container className="mt-5">
                        <Card>
                            <Card.Header>Create Nationality</Card.Header>
                            <Card.Body>
                                <Form>
