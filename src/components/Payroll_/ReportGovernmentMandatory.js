...
class ReportGovernmentMandatory extends Component {
    constructor(props) {
        super(props)
        this.state = {
            selectedClientId: "",
   ...
   onChangeClientList = (e) => {
    ...
    render() {
        ...
        const columnMandatedContribution = [
            {
        ...
        return(
            <div>
                ...
                <Container className="themed-container" fluid={true}>
                    <Card className="mt-5">
                        <Card.Header>Generate Report Government Mandated Contribution</Card.Header>
                        <Card.Body>
                            <Form>
                               ...
                               <Form.Group controlId="formGridPassword">
                                    ...
                                    <ToolkitProvider
                                        keyField="id"   
                                        data={ this.state.contributionListTable }
                                        columns={ columnMandatedContribution }
                                        exportCSV={ {
                                            fileName: "MandatoryContribution.csv",
                                        } }
                                        >
                                        {
                                            props => (
...
export default ReportGovernmentMandatory;